...
<template>
    <AvatarCardShell>
        <div class="flex flex-col md:flex-row py-5 gap-5 items-center">
            <div class="flex flex-col gap-5 w-full items-center md:flex-row">
                <div class="flex flex-col w-36 items-center justify-center md:w-32">
            ...
            <label class="text-white text-center text-lg font-bold justify-center items-center bg-purple py-3 rounded-md cursor-pointer my-auto w-2/3">

<template>
    <div class="w-full flex flex-col place-content-center">
        <div class="shadow-sm bg-neutral max-w-[880px] px-10 rounded-md max-md:px-5">
            <header class="flex gap-5 max-md:flex-col max-md:items-stretch max-md:gap-0">
                        ...
                        <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                            <section class="flex flex-col w-full max-md:ml-0 items-center justify-center md:w-60">
                                <img loading="lazy"
                                    ...
                                    class="aspect-square object-contain object-center w-[120px] overflow-hidden shrink-0 max-w-full rounded-[50%] " />
                            </section>
                ...
                <section class="flex flex-col items-center w-[21%] ml-5 max-md:w-full max-md:ml-0">
                    <button
                        class="text-white text-2xl whitespace-nowrap justify-center bg-primary w-full my-auto px-9 py-3 rounded-md border-solid border-primary max-md:mt-10 max-md:px-5"
